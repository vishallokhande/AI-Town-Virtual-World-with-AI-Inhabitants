...
function RootLayout() {
  ...
  // When Supabase is disabled, onboardingCompleted stays null — treat as ready when not authed.

  // On web, skip strict loading checks to avoid expo-router timeout.

  const isWeb = Platform.OS === 'web'

  const isWaiting = !isWeb && (!fontsLoaded || isAuthed === null || !i18nReady || (isAuthed === true && (onboardingCompleted === null || onboardingCompleted === false)))
